...
def get_default_config():
  ...
  # Run mode {"train", "eval_only", "cont_eval"}.
  # cont_eval is called programmatically by the xm_controller, so you
  # should only have to specify the former two
  ...
  # For run_mode=eval_only, if True, save to new xid folder, otherwise,
  # save to the checkpoint's corresponding metrics_{step} and examples_{step}
  # files
  config.eval_only_save_to_new_workdir = False
