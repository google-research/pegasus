...
Taken from
third_party/google_research/google_research/performer/fast_attention/jax/fast_attention.py
"""
...
class FastAttentionviaLowRankDecomposition(FastAttention):
  ...
  def dot_product_attention(self,
    ...
    if is_padding is not None:
      b, h, l, m = key_prime.shape
      is_padding = jnp.tile(jnp.reshape(is_padding, [b, 1, l, 1]), [1, h, 1, m])
      key_prime *= (1.0 - is_padding).astype(key_prime.dtype)
